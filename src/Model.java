...
public class Model {
    ...
    private ArrayList<String> batSpéciaux;
    private ArrayList<String> batNeutre;
    private ArrayList<String> batBois;
    private ArrayList<String> batPierre;
    private ArrayList<String> batPrestiqe;
    private ArrayList<String> batResidentiel;
